  ...
  return (
    ...
    <main>
      <div className="flex flex-col justify-center items-center mx-auto p-5 gap-2.5 border w-[199px] m-8 shadow-lg shadow-indigo-500/10">
        ...
        <Button variant="disable" className="gap-2"> 
          <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Button variant="outline" className="text-[#0F172A]">Cancel</Button>

        <Button variant="subtle" className="text-[#0F172A]">Subtle</Button>

        <Button variant="ghost" className="text-[#0F172A]">Ghost</Button>

        <Button variant="link" className="text-[#0F172A]">Link</Button>

        <Button variant="outline" className="text-[#0F172A] p-2 w-8 h-8 ">
        ...
        <Button variant="outline" className="text-[#0F172A] p-3 w-10 h-10 ">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M8 3.33331V12.6666" stroke="black" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M3.33337 8H12.6667" stroke="black" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
